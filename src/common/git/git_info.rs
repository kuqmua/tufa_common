...
impl<'a> crate::traits::fields::GetGitCommitId<'a> for GitInformation<'a> {
    fn get_git_commit_id(&self) -> &'a str {
        self.git_commit_id
    }
}

impl<'a> crate::traits::fields::GetGitRepoLink<'a> for GitInformation<'a> {
    fn get_git_repo_link(&self) -> &'a str {
        self.git_repo_link
    }
}

impl<'a> crate::traits::fields::GetGitAuthor<'a> for GitInformation<'a> {
    fn get_git_author(&self) -> &'a str {
        self.git_author
    }
}

impl<'a> crate::traits::fields::GetGitAuthorEmail<'a> for GitInformation<'a> {
    fn get_git_author_email(&self) -> &'a str {
        self.git_author_email
    }
}

impl<'a> crate::traits::fields::GetGitCommitUnixTime<'a> for GitInformation<'a> {
    fn get_git_commit_unix_time(&self) -> &'a str {
        self.git_commit_unix_time
    }
}

impl<'a> crate::traits::fields::GetGitTimezone<'a> for GitInformation<'a> {
    fn get_git_timezone(&self) -> &'a str {
        self.git_timezone
    }
}

impl<'a> crate::traits::fields::GetGitMessage<'a> for GitInformation<'a> {
