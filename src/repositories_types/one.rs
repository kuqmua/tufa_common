...
pub enum OneError<'a> {
    Something {
        inner_error: crate::repositories_types::three_four_five_six_seven_eight::ThreeError<'a>,
        code_occurence: crate::common::code_occurence::CodeOccurence<'a>,
    },
}

// impl<'a> std::fmt::Display for OneError<'a> {
...
// impl<'a> crate::traits::error_logs_logic::source_to_string_without_config::SourceToStringWithoutConfig<'a> for OneError<'a> {
//     fn source_to_string_without_config(&self) -> String {
//         match self {
//             OneError::Something { inner_error, code_occurence: _code_occurence } => {
//                 use crate::traits::error_logs_logic::to_string_without_config::ToStringWithoutConfig;
...
// pub enum OneErrorWithDeserialize<'a> {
//     Something {
//         #[serde(borrow)]
//         inner_error: OneErrorEnumWithDeserialize<'a>,
//         #[serde(borrow)]
//         code_occurence: crate::common::code_occurence::CodeOccurenceWithDeserialize<'a>,
//     },
// }

// impl<'a> std::fmt::Display for OneErrorWithDeserialize<'a> {
//     fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
...
// impl<'a> crate::traits::error_logs_logic::source_to_string_without_config::SourceToStringWithoutConfig<'a> for OneErrorWithDeserialize<'a> {
//     fn source_to_string_without_config(&self) -> String {
//         match self {
//             OneErrorWithDeserialize::Something { inner_error, code_occurence: _code_occurence } => {
//                 use crate::traits::error_logs_logic::to_string_without_config::ToStringWithoutConfigWithDeserialize;
