...
// pub struct UpdateOnePathForUrlEncoding {
//     pub id: crate::server::postgres::uuid_wrapper::PossibleUuidWrapper,
// }
// //
// #[derive(Debug, thiserror :: Error, error_occurence :: ErrorOccurence)]
// pub enum UpdateOnePathTryFromUpdateOnePathForUrlEncodingErrorNamed {
//     NotUuid {
//         #[eo_error_occurence]
//         not_uuid:
...
//     },
// }
// impl std::convert::TryFrom<UpdateOnePathForUrlEncoding> for UpdateOnePath {
//     type Error = UpdateOnePathTryFromUpdateOnePathForUrlEncodingErrorNamed;
//     fn try_from(value: UpdateOnePathForUrlEncoding) -> Result<Self, Self::Error> {
...
//         axum::extract::Path<UpdateOnePathForUrlEncoding>,
...
//                 Ok(value) => value,
//                 Err(e) => {
//                     let error = TryUpdateOne::UpdateOnePathTryFromUpdateOnePathForUrlEncoding {
//                         update_one_path_try_from_read_one_path_for_url_encoding: e,
//                         code_occurence: crate::code_occurence_tufa_common!(),
//                     };
...
//             Ok(_) => TryUpdateOneResponseVariants::Desirable(()),
//             Err(e) => {
//                 let error = TryUpdateOne::from(e);
//                 crate::common::error_logs_logic::error_log::ErrorLog::error_log(
//                     &error,
