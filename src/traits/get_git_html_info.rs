...
pub trait GetGitHtmlInfoLifetime {
    fn get_git_html_info_lifetime(&self) -> String;
}

impl<T> GetGitHtmlInfo for T
where
    T: crate::traits::fields::GetGitAuthor
        + crate::traits::fields::GetGitAuthorEmail
        + crate::traits::fields::GetGitCommitId
...
impl<'a, T> GetGitHtmlInfoLifetime for T
where
    T: crate::traits::fields::GetGitAuthorLifetime<'a>
        + crate::traits::fields::GetGitAuthorEmailLifetime<'a>
        ...
        + crate::traits::fields::GetGitTimezoneLifetime<'a>,
{
    fn get_git_html_info_lifetime(&self) -> String {
        ...
        let git_repo_link = self.get_git_repo_link_lifetime();
        let git_author = self.get_git_author_lifetime();
        let git_author_email = self.get_git_author_email_lifetime();
        let git_commit_unix_time = self.get_git_commit_unix_time_lifetime();
        let git_timezone = self.get_git_timezone_lifetime();
        let git_message = self.get_git_message_lifetime();
        let git_commit_link = self.get_git_commit_link_lifetime();
        format!(
            r#"<!DOCTYPE html>
<html>
