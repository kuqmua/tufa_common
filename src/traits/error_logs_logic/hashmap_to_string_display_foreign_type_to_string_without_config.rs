pub trait HashMapToStringDisplayForeignTypeToStringWithoutConfig<'a> {
    fn hashmap_to_string_display_foreign_type_to_string_without_config(&self) -> String;
}

impl<'a, HashMapKeyGeneric, HashMapValueGeneric>
    HashMapToStringDisplayForeignTypeToStringWithoutConfig<'a>
