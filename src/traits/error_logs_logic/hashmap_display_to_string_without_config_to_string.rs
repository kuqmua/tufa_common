...
pub trait HashmapDisplayToStringWithoutConfigToStringWithDeserialize<'a> {
    fn hashmap_display_to_string_without_config_to_string_with_deserialize(&self) -> String;
}

impl<'a, HashMapKeyGeneric, HashMapValueGeneric> HashmapDisplayToStringWithoutConfigToStringWithDeserialize<'a>
    for std::collections::HashMap<HashMapKeyGeneric, HashMapValueGeneric>
where
    HashMapKeyGeneric: std::fmt::Display,
    HashMapValueGeneric:
