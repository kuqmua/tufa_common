...
pub mod hashmap_display_foreign_type_display_foreign_type_into_hashmap_static_str_static_str;
pub mod hashmap_display_foreign_type_display_foreign_type_to_string;
pub mod hashmap_display_foreign_type_display_into_hashmap_static_str_display;
...
pub mod vec_display_foreign_type_into_vec_static_str;
