...
pub mod hashmap_display_foreign_type_impl_display_into_hashmap_string_impl_display;
...
pub mod hashmap_impl_display_display_foreign_type_into_hashmap_impl_display_string;
