...
///////////////////////////////////////////
pub trait ToStringWithConfigLifetimeWithDeserialize<'a, ConfigGeneric> {
    fn to_string_with_config_lifetime_with_deserialize(&self, config: &ConfigGeneric) -> String;
}

impl<'a, SelfGeneric, ConfigGeneric> ToStringWithConfigLifetimeWithDeserialize<'a, ConfigGeneric> for SelfGeneric
where
    SelfGeneric:
        ...
        + crate::traits::get_server_address::GetServerAddress,
{
    fn to_string_with_config_lifetime_with_deserialize(&self, config: &ConfigGeneric) -> String {
        crate::traits::error_logs_logic::helpers::source_and_code_occurence_formatter(
            self.source_to_string_with_config_lifetime_with_deserialize(config),
