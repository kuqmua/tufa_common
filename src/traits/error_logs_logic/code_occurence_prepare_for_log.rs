...
/////////////////////////////////////////////////////
pub trait CodeOccurencePrepareForLogWithConfigWithDeserialize<
    ConfigGeneric: crate::traits::fields::GetTimezone
        + crate::traits::fields::GetSourcePlaceType
        + crate::traits::get_server_address::GetServerAddress,
>
{
    fn code_occurence_prepare_for_log_with_config_with_deserialize(
        &self,
        config: &ConfigGeneric,
    ) -> String;
}

impl<SelfGeneric, ConfigGeneric> CodeOccurencePrepareForLogWithConfigWithDeserialize<ConfigGeneric>
    for SelfGeneric
where
    SelfGeneric: crate::traits::fields::GetFile
        + crate::traits::fields::GetLine
