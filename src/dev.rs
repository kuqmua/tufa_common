...
pub fn named<'a>() -> Result<(), Box<NamedError<'a>>> {
    return Err(Box::new(NamedError::Something {
        ...
        eo_str_display_with_serialize_deserialize: "eo_str_display_with_serialize_deserialize",
        eo_string_display_with_serialize_deserialize: std::string::String::from("eo_string_display_with_serialize_deserialize"),
        ...
        eo_vec_str_display_with_serialize_deserialize: vec!["eo_vec_str_display_with_serialize_deserialize"],
        eo_vec_string_display_with_serialize_deserialize:  vec![std::string::String::from("eo_vec_string_display_with_serialize_deserialize")],
