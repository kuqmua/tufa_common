...
//     MongoGetDocumentsAsStringVector(crate::server::mongo_integration::mongo_get_documents_as_string_vector::MongoGetDocumentsAsStringVectorErrorNamed<'a>),
// }
...
//                 Vec<String>
//         >, 
//         crate::server::mongo_integration::mongo_get_providers_link_parts::MongoGetProvidersLinkPartsErrorNamed<'a>
//     > {
//         let db = config.get_mongo_client().database("providers_link_parts");
//         match db.list_collection_names(None).await {
//             Err(e) => Err(
//                 crate::server::mongo_integration::mongo_get_providers_link_parts::MongoGetProvidersLinkPartsErrorNamed::MongoDB {
//                     mongodb: e,
...
//                     return Err(
//                         crate::server::mongo_integration::mongo_get_providers_link_parts::MongoGetProvidersLinkPartsErrorNamed::NoSuchCollections {
...
//                             (
//                                 *pk,
//                                 crate::server::mongo_integration::mongo_get_documents_as_string_vector::mongo_get_documents_as_string_vector(
...
//                     String,
//                     crate::server::mongo_integration::mongo_get_providers_link_parts::MongoGetDocumentsAsStringVectorErrorUnnamed,
...
//                                 pk.to_string(), 
//                                 crate::server::mongo_integration::mongo_get_providers_link_parts::MongoGetDocumentsAsStringVectorErrorUnnamed::MongoGetDocumentsAsStringVector(*e)
//                             );
//                         }
//                         Ok(vec) => {
...
//                     return Err(
//                         crate::server::mongo_integration::mongo_get_providers_link_parts::MongoGetProvidersLinkPartsErrorNamed::GetDocuments {
